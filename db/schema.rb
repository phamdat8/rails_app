...
ActiveRecord::Schema.define(version: 2021_11_24_072503) do
  ...
  create_table "property_values", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_type_id"], name: "index_property_values_on_product_type_id"
  ...
  add_foreign_key "property_values", "product_types"
